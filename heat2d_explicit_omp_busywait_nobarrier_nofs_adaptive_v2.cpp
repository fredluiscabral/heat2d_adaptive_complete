...
//
// Backend de WAIT: polling acquire + _mm_pause/yield.
//
...
int main() {
    ...
    heat2d::print_summary("omp_busywait_nofs_adaptive_v2",p,dt,mu,secs,err);
