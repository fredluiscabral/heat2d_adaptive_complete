...
SM_WCAL_COMPAT_BIN := heat2d_wait_calibrate_sem
...
BW_V2_BIN := heat2d_adaptive_v2_busywait
SM_V2_BIN := heat2d_adaptive_v2_sem
...
calibrators: $(BW_WCAL_BIN) $(SM_WCAL_BIN) $(SM_WCAL_COMPAT_BIN)
adaptive: $(BW_ADP_BIN) $(SM_ADP_BIN)
diagnostics: $(BW_PROF_BIN) $(SM_PROF_BIN)
profiles: diagnostics
# Compatibility target used by the SDumont experiment scripts.
...
$(SM_WCAL_COMPAT_BIN): $(SM_WCAL_BIN)
	cp -f $(SM_WCAL_BIN) $(SM_WCAL_COMPAT_BIN)
...
$(BW_V2_BIN): $(BW_V2_SRC) $(COMMON)
	$(CXX) $(CXXFLAGS) -DHEAT2D_PROFILE_STATS=0 $(BW_V2_SRC) -o $@ $(LDFLAGS)

$(SM_V2_BIN): $(SM_V2_SRC) $(COMMON)
	$(CXX) $(CXXFLAGS) -DHEAT2D_PROFILE_STATS=0 $(SM_V2_SRC) -o $@ $(LDFLAGS)

$(BW_V2_PROF_BIN): $(BW_V2_SRC) $(COMMON)
	$(CXX) $(CXXFLAGS) -DHEAT2D_PROFILE_STATS=1 $(BW_V2_SRC) -o $@ $(LDFLAGS)

$(SM_V2_PROF_BIN): $(SM_V2_SRC) $(COMMON)
	$(CXX) $(CXXFLAGS) -DHEAT2D_PROFILE_STATS=1 $(SM_V2_SRC) -o $@ $(LDFLAGS)
